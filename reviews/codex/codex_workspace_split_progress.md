...
Step 7 review fix: committed 76ee786. Tests: 304/304. Smoke check: skipped. Notes: restored three Unicode characters in `charts.py`; also split static cache headers so vendored assets stay immutable while repo-owned assets revalidate, with test coverage.
...
Post-review fixes: committed 49d2ee8. Tests: 306/306. Smoke check: skipped. Notes: merged Claude and Codex final reviews; fixed cache-path normalization, missing `Any` imports, unused import, blank-line drift, progress-log gap, and added regression tests from `reviews/codex/merged_workspace_split_final_review.md`.
