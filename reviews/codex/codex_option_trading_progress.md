...
- Merged Claude/Codex full-review fixes: gated full option-data loading to the option-trading lens, left a lightweight link on normal ticker pages, clarified the Hedge Readiness subset and constant-IV model assumptions in the UI, and suppressed unused quantity warnings for valid budget-mode calculator requests.
