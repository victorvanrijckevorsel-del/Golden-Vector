...
def build_gold_regime_frame(
    ...
    *,
    ...
    if downside_hit_rate_threshold >= 0:
        raise ValueError("downside_hit_rate_threshold must be negative")
    if upside_hit_rate_threshold <= 0:
        raise ValueError("upside_hit_rate_threshold must be positive")
    ...
    gold["gold_down_hit_event"] = ready & gold["gold_log_ret"].le(
        downside_hit_rate_threshold
    )
    gold["gold_up_hit_event"] = ready & gold["gold_log_ret"].ge(
        upside_hit_rate_threshold
    )
