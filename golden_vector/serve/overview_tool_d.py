...
def _render_tool_d_overview_page(
    ...
    *,
    ...
    body.append(
        ...
        "<th data-col-name=\"quality_rank\" data-sort-numeric title=\"Percentile rank of the Quality Score across the universe\">Quality Rank</th>"
        "<th data-col-name=\"quality_score\" data-sort-numeric title=\"Average of the percentile ranks of Headroom, Stressed Leverage and EV/EBITDA at the gold price\">Quality Score</th>"
        "<th data-col-name=\"gold_price\" data-sort-numeric title=\"Gold price used for every 'at gold' figure in this row\">Gold Price</th>"
        "<th data-col-name=\"headroom\" data-sort-numeric title=\"(Gold price - AISC) / Gold price -- how far gold can fall before the miner hits breakeven\">Headroom</th>"
        "<th data-col-name=\"leverage\" data-sort-numeric title=\"Net Debt / EBITDA, with EBITDA recomputed at the gold price (negative = net cash)\">Stressed Leverage</th>"
        "<th data-col-name=\"ev_ebitda\" data-sort-numeric title=\"Enterprise Value / EBITDA, at the gold price\">EV/EBITDA</th>"
        "<th data-col-name=\"margin\" data-sort-numeric title=\"Gold price - AISC (cash margin per ounce)\">Margin/Oz</th>"
        "<th data-col-name=\"fcf_yield\" data-sort-numeric title=\"Sustainable free cash flow / market cap\">FCF Yield</th>"
