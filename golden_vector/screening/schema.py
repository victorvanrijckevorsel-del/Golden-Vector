...
REQUIRED_TOOL_B_FUNDAMENTAL_COLUMNS = {
    ...
    "ev_ebitda_official",
    "ev_ebitda_differs",
    "ev_ebitda_alternate_value",
    "ev_ebitda_alternate_label",
    "ev_ebitda_show_alternate",
    "leverage_our_view",
    "leverage_official",
    "leverage_differs",
    "leverage_alternate_value",
    "leverage_alternate_label",
    "leverage_show_alternate",
    "net_debt_musd_our_view",
    "net_debt_musd_official",
    "ebitda_ltm_musd",
    "ebitda_ltm_musd_our_view",
    "ebitda_ltm_musd_official",
    ...
    "forward_pe_our_view",
    "forward_pe_official",
    "aisc_margin_est_musd_our_view",
    "aisc_margin_yield_our_view",
    "aisc_margin_yield_official",
