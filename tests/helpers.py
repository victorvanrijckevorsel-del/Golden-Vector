...
def tool_b_output_row(
    ...
    *,
    ...
    return {
        ...
        "sustainable_fcf_musd_our_view": sustainable_fcf_musd,
        "sustainable_fcf_musd_official": sustainable_fcf_musd,
        "fcf_yield_our_view": fcf_yield,
        "fcf_yield_official": fcf_yield,
    }
